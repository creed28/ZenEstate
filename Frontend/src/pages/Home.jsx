   ...
   <section className='h-full max-h-[640px] mb-8 xl:mb-24 bg-primary-grey'>
    <div className='flex flex-col lg:flex-row'>
      <div className='lg:ml-8 xl:ml-[135px] flex flex-col items-center lg:items-start text-center lg:text-left justify-center flex-1 px-4 lg:px-0'>
        <h1 className='uppercase text-4xl lg:text-[58px] font-semibold leading-none mb-6 '>Meet <span className='text-[#616161]'>Your</span> New Home<span className='text-[#616161]'>.</span></h1>
      ...
      <div className='hidden flex-1 lg:flex justify-end items-end mt-10'>
        <img src={Image} alt="Hero House Image" width={650} />
      </div>
    </div>
    <Search />
   </section>
