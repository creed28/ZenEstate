...
const Property = ({house, key}) => {
  const {image, type, city, address, bedrooms, bathrooms, surface, price} = house;
  return (
    <div className='bg-[white] shadow-1 p-5 rounded-lg rounded-tl-[90px] w-full max-w-[352px] mx-auto cursor-pointer hover:drop-shadow-2xl transition'>
      ...
      <div className='flex gap-x-4 my-4'>
        <div className='flex items-center text-[#939393] gap-1'>
