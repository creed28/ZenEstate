    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContractsList", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ContractsList_Contracts_ContractId",
                        column: x => x.ContractId,
                        principalTable: "Contracts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ContractsList_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContractsList_ContractId",
                table: "ContractsList",
                column: "ContractId");

            migrationBuilder.CreateIndex(
                name: "IX_ContractsList_UserId",
                table: "ContractsList",
                column: "UserId",
                unique: true);
        }
